...
describe('PairNamer', () => {
  ...
  describe('#pairName', () => {
    ...
    it('concatenation', async () => {
      expect(await pairName('DAI Stable Coin', 'MKR Token', 'forceswap V2 Liquidity Provider Share for ', '.')).to.eq(
        'forceswap V2 Liquidity Provider Share for DAI Stable Coin:MKR Token.'
      )
    })
  })
